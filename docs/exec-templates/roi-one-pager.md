...
2. **Adjust** the metrics in the Measured Improvements section to reflect what you actually tracked.
3. **Validate** calculations with your finance team before presenting externally.
4. **Keep it to one page** — this is designed to be a concise, self-contained narrative.
