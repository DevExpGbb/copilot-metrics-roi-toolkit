...
<ol class="chapter-list" markdown>
  <li markdown>
    :material-sign-direction:{ .lg .middle } **[Measurement Journey](measurement-journey.md)**
    <span class="chapter-list__desc">See the two-phase model, pick the right measurement path, and decide when to move from adoption into ROI.</span>
  </li>
  <li markdown>
    :material-rocket-launch:{ .lg .middle } **[Adoption](adoption/index.md)**
    <span class="chapter-list__desc">Measure seat usage, acceptance, feature mix, and the signals that tell you enablement is working.</span>
  </li>
  <li markdown>
  ...
  <li markdown>
    ...
    <span class="chapter-list__desc">Reuse KPI, ROI, QBR, and measurement-plan artifacts instead of starting from a blank page.</span>
  </li>
  <li markdown>
    :material-book-open:{ .lg .middle } **[Reference](reference/index.md)**
    <span class="chapter-list__desc">Jump straight to dashboards, APIs, tool comparisons, glossary terms, and supporting sources.</span>
  </li>
</ol>
