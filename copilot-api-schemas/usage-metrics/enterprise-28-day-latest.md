# Get Copilot Enterprise Usage Metrics (28-Day)
...
## Description
Returns signed download URLs for the most recent complete 28-day enterprise Copilot usage metrics report. Use this endpoint for rolling-window trend analysis across the full enterprise.
...
curl -L \
  ...
  "https://api.github.com/enterprises/avocado-corp/copilot/metrics/reports/enterprise-28-day/latest"
```
...
{
  "download_links": [
    "https://storage.example.com/signed/enterprise-28-day-part1.ndjson?token=abc123&expires=1700000000"
  ],
...
## References
- [Official API Documentation](https://docs.github.com/en/enterprise-cloud@latest/rest/copilot/copilot-usage-metrics?apiVersion=2026-03-10#get-copilot-enterprise-usage-metrics)
